...
the the RandomFields package. All the data generated by the RandomFields package was generated and saved in the "RandomFieldsData" subfolder. 
Continuous data were rounded due to storage limits on GitHub. 

These simulations reads in the saved RandomFields data and uses it to generate the full data. However, the full data in this simulation 
...
For all simulation subfolders, args_list.csv contains all the parameters settings, and the (noRandomFields) versions do not require
the RandomFields package (as explained above).
