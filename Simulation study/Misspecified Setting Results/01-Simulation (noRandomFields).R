...
for(args in 1:54){
  ...
  misp_data_mat <- readRDS(paste0("Simulation study",delim,"RandomFieldsData",delim,"misp_data K=",K," eta=",eta," C=",C," mis_sp=",mis_sp," start=",start,".rds"))
